...
<div class="container rtl row">
	<br><div class="col s12 m10 l10 offset-m1 offset-l1">
        <div class="card-panel" style="padding: 18px;">
			<center><b>
				این وبسایت برای
				<a href="http://twitch.tv/beastqt">BeastQT</a>.
				طراحی شده است. او یک استریمر عالی روس است.
			</b></center>
			<br>
			<div style="margin-bottom: 10px" class="divider"></div>
			<center>
				<a style="background-color: rgba(0,0,0,0.05)" onclick="selectAll()" class="topbutton waves-effect waves-orange btn-flat">انتخاب همه</a>
				<a style="background-color: rgba(0,0,0,0.05)" onclick="unselectAll()" class="topbutton waves-effect waves-orange btn-flat">لغو انتخاب ها</a>
				<a style="background-color: rgba(0,0,0,0.05)" onclick="clearAllLatency()" class="topbutton waves-effect waves-orange btn-flat">پاکسازی</a>
				<a style="background-color: rgba(0,0,0,0.05)" class="topbutton dropdown-button btn-flat" data-activates="dropdown">منطقه</a>
				<ul id="dropdown" class="dropdown-content">
					<li><a onclick="selectAmerica()">آمریکا</a></li>
					<li><a onclick="selectEurope()">اوروپا</a></li>
					<li><a onclick="selectAsia()">آسیا</a></li>
				</ul>
				<a style="background-color: rgba(0,0,0,0.05)" onclick="saveSettings()" class="topbutton waves-effect waves-orange btn-flat">ذخیره</a>
			</center>
			<table id="grid" class="highlight striped">
				<thead>
					<tr>
						<th style="width:20px" data-type="string">انتخاب</th>
						<th style="width:250px" data-type="string">سرور:</th>
						<th style="width:300px" data-type="number">پینگ:</th>
						<th data-type="number">میانگین:</th>
				...
				<tbody>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(0)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(0)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(1)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(1)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(2)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(2)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(3)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(3)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(4)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(4)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(5)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(5)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(6)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(6)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(7)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(7)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(8)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(8)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(9)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(9)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(10)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(10)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(11)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(11)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(12)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(12)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(13)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(13)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
					<tr>
						...
						<td></td>
						<td><a onclick="checkButtonClicked(14)" class="waves-effect waves-orange btn-flat actionbutton">بررسی</a><a onclick="clearLatency(14)" class="waves-effect waves-orange btn-flat actionbutton">پاکسازی</a></td>
					</tr>
				</tbody>
			</table>
			<div class="divider"></div><div id="imageCell"></div><br>
			<center>
				<a class="orange waves-effect waves-light btn tooltipped pulse" data-position="top" data-delay="50" data-tooltip="تست پینگ" type="submit" id="pingbutton" onclick="Materialize.toast('درحال تست پینگ شما!', 3500)">شروع</a>
				<a class="orange waves-effect waves-light btn tooltipped" href="#modalinfo" data-position="top" data-delay="50" data-tooltip="مشاهده راهنما">راهنما</a>
				<a class="orange waves-effect waves-light btn tooltipped" href="#modalservers" data-position="top" data-delay="50" data-tooltip="مشاهده لیست سرور ها">لیست</a>
				<a class='dropdown-button orange waves-effect waves-light btn tooltipped' data-position="top" data-delay="50" data-tooltip="تغییر زبان" href='#' data-activates='langdropdown'>زبان</a>
			</center>
			...
			<div id="modalinfo" class="modal modal-fixed-footer">
				<div class="modal-content">
					<h4>راهنما</h4><div class="divider"></div>
					<br>
					<b> در صورتی که ایده ای برای بهبود این وبسایت دارد ، از طریق فرم زیر با ما در ارتباط باشید. فقط زبان انگلیسی و روسی! </b>
					<div class="row">
						<div id="feedbackdiv" class="input-field col s9">
							<textarea id="feedbackarea" class="materialize-textarea" length="500"></textarea>
							<label style="top: 4px; left: 16px" for="feedbackarea">متن...</label>
						</div>
						<div class="col s3"><a onclick="sendfeedback();" style="height: 100px; padding-top: 23%;" class="waves-effect waves-orange btn-flat">ارسال</a></div>
					</div>
					<p><b>منبع</b> - برای مشاهده کدهای این وبسایت می توانید از طریق <a href="https://github.com/Disquse/PUBGServersPing">GitHub</a> اقدام کنید. قبل از استفاده حتما لایسنس را مطالعه کنید.</p>
					<p><b>پینگ خوبی دارم ولی بازهم لگ هستم!</b> - مشکلی اصلی سرور های بازی پابجی، پینگ سرور ها و یا اینترنت شما نیست! مشکل حجم زیاد بازیکن ها هست که باعث افت سرعت لود شما می شود.
						در صورت وجود این مشکل، در سرور دیگری بازی کنید.
					</p>
					<p><b>این وبسایت چگونه کار میکند؟</b> - پس از فشردن دکمه شروع، از سمت اینترنت شما درخواستی برای تمامی سرور های AWS (Amazon Web Services) ارسال می شود که سرور های این بازی بر روی آن قرار دارند. به دلیل اینکه این درخواست از سمت اینترنت شما ارسال می شود
						پینگ باید به درستی محاسبه شود.
					</p>
					<p><b>این وبسایت برای چه کسانی است؟</b> - برای بازیکنان پابجی، Banda و rabotyag <i><3</i></p>
					<p><b>با تشکر از:</b></p>
					<br>
					<p><a href="https://github.com/nino6454">nino6454</a> برای ترجمه اسپانیایی</p>
					<p><a href="https://github.com/Cethiel">Cethiel</a> برای ترجمه فرانسوی</p>
					<p><a href="https://github.com/ngocnh">NgocNH</a> برای ترجمه ویتنامی</p>
					<p><a href="https://github.com/atig3r">AlirezaTiG3R</a> برای ترجمه فارسی</p>
				</div>
				<div class="modal-footer">
					<a class="modal-action modal-close waves-effect waves-orange btn-flat">بستن</a>
				</div>
			</div>
			<div id="modalservers" class="modal modal-fixed-footer">
				<div class="modal-content">
					<h4>لیست تمامی سرور های AWS</h4><div class="divider"></div>
					AWS (Amazon Web Services):<br><br>
...
<script type="text/javascript">
	...
	function enablePingButton() {
		...
		Materialize.toast('انجام شد!', 2000);
	};
	...
	function saveSettings() {
		...
		Materialize.toast('تنظیمات شما ذخیره شد!', 2000);
	}
